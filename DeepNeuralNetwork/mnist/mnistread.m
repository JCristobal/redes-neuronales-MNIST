...
if( ~exist('mnistfilenames') )
    ...
    mnistfilenames{1} = '../../data/train-images.idx3-ubyte';
    mnistfilenames{2} = '../../data/train-labels.idx1-ubyte';
    mnistfilenames{3} = '../../data/t10k-images.idx3-ubyte';
    mnistfilenames{4} = '../../data/t10k-labels.idx1-ubyte';
end
